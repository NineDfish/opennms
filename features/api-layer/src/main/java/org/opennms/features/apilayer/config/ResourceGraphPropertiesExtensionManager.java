...
public class ResourceGraphPropertiesExtensionManager extends ConfigExtensionManager<GraphPropertiesExtension, PrefabGraphs>{


    public ResourceGraphPropertiesExtensionManager() {
    ...
    protected PrefabGraphs getConfigForExtensions(Set<GraphPropertiesExtension> extensions) {
        List<org.opennms.netmgt.model.PrefabGraph> graphList = extensions.stream().flatMap(extension -> extension.getPrefabGraphs().stream())
                .map(ResourceGraphPropertiesExtensionManager::toPrefabGraphs)
